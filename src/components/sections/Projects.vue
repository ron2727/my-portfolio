                ...
                <div class=" space-y-3 md:space-y-7 text-default">
                    ...
                    <div class="wrapper block sm:flex items-center justify-between">
                        ...
                        <div class="button-links space-x-3 mt-3 sm:mt-0">
                            <a href="#" class=" inline-block px-4 border border-dark-secondary text-dark-secondary text-xs lg:text-sm text-center font-medium py-2 lg:py-3 transition-colors duration-200 hover:text-white hover:border-dark-secondary hover:bg-dark-secondary dark:text-dark-secondary dark:border-dark-secondary">
                                Demo</a>
                            <a href="#" class=" inline-block px-4 border border-dark-secondary text-dark-secondary text-xs lg:text-sm text-center font-medium py-2 lg:py-3 transition-colors duration-200 hover:text-white hover:border-dark-secondary hover:bg-dark-secondary dark:text-dark-secondary dark:border-dark-secondary">Code</a>
                        </div>
                    </div>
