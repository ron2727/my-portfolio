<template>
    <div class=" wrapper relative">
       <img id="left" src="../assets/image/projects/web_portal.png" class=" absolute top-0 left-0 z-10 translate-y-12 -rotate-12 w-64 h-52 object-cover border rounded-md dark:border-white bg-white transition-all hover:z-30 hover:scale-110"/>
